    ...
    <div class="container">
      <div class="breadcrumbs-text ">
        <ol>
          ...
          <li><a href="/disucss" class="breadcrumbs-link">Disucss</a></li>
        </ol>
        <h1>Disucss</h1>
      </div>
    </div>
...
<section class="discuss">
  <div class="container-fluid  pt-5 pb-2 bg-light" data-aos="fade-up">
    <div class="row ">
        ...
        <button id="myBtn" class="btn btn-sub m-left">شارك الان </button>
                ...
                <div class="modal-content">
                    ...
                    <form class='' action = "" method='POST' enctype="multipart/form-data">
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                <label for="body" class="form-label">اسال الان </label>
        ...
        <div class="card mb-3 ">
                <div class="card-body">
                  <h5 class="card-title"> لهاتفها الأكثر تقدمًا</h5>
