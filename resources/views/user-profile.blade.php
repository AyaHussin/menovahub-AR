        ...
        <div class="col-md-8 border border-light">
            <div class="p-3 py-5">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-12 mb-3">
                        <label class="labels text-right">Email </label>
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" id = 'state' name = 'state' class="form-control" placeholder="enter address line 2" >
                    </div>
                </div>

                <div class="mt-5 text-center">
                    <button class="btn btn-sub" type="button">Save Profile</button>
                </div>
            </div>
    </div>
    </div>
