...
<section class="breadcrumbs">
    <div class="container">
      <div class="breadcrumbs-text">
        ...
        <li><a class="breadcrumbs-link " href="/projects">Projects</a></li>
        </ol>
   ...
   <div class="container" data-aos="fade-up">
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4 mb-5">
            ...
            <div class="col project-box">
                ...
                <img src="assets/img/projects/project-4.jpg" class="card-img-top" alt="...">
                <div class="card-body">
    ...
    <div class="row row-cols-1 row-cols-md-3 g-4">
        ...
        <div class="col project-box">
            ...
            <div class="card-body">
                ...
                <p class="card-text"> عام 2016 وبعد شهر واحد من إطلاق شركة سامسونج لهاتفها الأكثر تقدمًا “غالاكسي نوت 7″، تفاجأ العملاء بأكثر المشاكل خطورة وهي انفجار البطاريات وقد واجه</p>
            </div>
            <div class="card-footer">
                <div class="social d-flex justify-content-center align-item-center">
                    <a href=""> <i class="bi bi-chat-left-dots-fill"></i>messege</a>
